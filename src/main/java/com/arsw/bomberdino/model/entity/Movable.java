...
/**
 * Interface for entities that can move on the game grid.
 * Defines movement capabilities and collision validation.
 * 
...
public interface Movable {
     ...
     * Updates entity position if movement is valid.
     * 
     ...
     * Validates tile availability and collision rules.
     * 
     ...
     * Speed determines tiles moved per action.
     * 
