...
/**
 * Event listener for domain events that require WebSocket broadcasting.
 * Listens to game events and broadcasts updates to connected clients.
 * All methods are async to prevent blocking the event publisher.
 *
...
public class WebSocketEventListener {
    ...
    /**
     * Handles GameStateChangedEvent by broadcasting full game state.
     * Sends GameStateUpdateDTO to all clients subscribed to the session topic.
     *
    ...
    public void onGameStateChanged(GameStateChangedEvent event) {
        try {
            ...
            GameStateUpdateDTO gameState = gameFacadeService.getGameState(sessionId);
    ...
    /**
     * Handles PlayerKilledEvent by broadcasting kill notification.
     * Sends PlayerKilledDTO to all clients for UI kill feed updates.
     *
    ...
    /**
     * Handles BombExplodedEvent by broadcasting explosion details.
     * Sends BombExplodedDTO with affected tiles for client-side animation.
     *
    ...
    /**
     * Broadcasts a custom message to a session topic.
     * Utility method for ad-hoc notifications.
     *
